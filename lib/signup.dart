...
class _SignupPageState extends State<SignupPage> {
  ...
  Future<void> _signup() async {
    ...
    final response = await http.post(
      Uri.parse('http://localhost/apple/signup.php'),
      body: {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          'Sign Up',
          style: TextStyle(color: Color.fromARGB(124, 106, 90, 131)),
        ),
      ),
      body: Padding(
          ...
          children: [
            ...
            ElevatedButton(
              ...
              child: Text(
                'Sign Up',
                style: TextStyle(
                  color: Color.fromARGB(124, 106, 90, 131),
                  fontFamily: 'RobotoMono',
                ),
              ),
            ),
      ...
      backgroundColor: Color.fromARGB(124, 106, 90, 131),
    );
  }
}
